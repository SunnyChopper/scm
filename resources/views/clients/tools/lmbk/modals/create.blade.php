<div class="modal fade" id="create_lead_modal" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Create New Lead Magnet Idea</h5>
			...
			<div class="modal-body">
				<div class="form-group row">
					...
					<div class="col-12 mt-32">
						...
						<input type="text" class="form-control" id="create_title" placeholder="Title">
					</div>
					...
					<div class="col-12 mt-32">
						...
						<input type="text" class="form-control" id="create_promise" placeholder="Promise">
					</div>
					...
					<div class="col-12 mt-32">
						...
						<textarea rows="4" id="create_hook" class="form-control" placeholder="Hook"></textarea>
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success create_lead">Create</button>
			</div>
		</div>
	</div>
</div>